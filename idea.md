...
### Таблица проектов
- **Список проектов**: табличное представление всех проектов с основной информацией
- **Столбцы**: название, организация, регион, год, направление, сумма, статус
- **Сортировка**: по любому столбцу (название, сумма, год, регион)
- **Пагинация**: загрузка по 100-1000 проектов для быстрой работы
- **Синхронизация с картой**: выделение в таблице соответствует выделению на карте
- **Экспорт**: возможность скачать данные в CSV/Excel формате
...
- **Расширенная таблица**: дополнительные столбцы, группировка, сводные таблицы
- **Аналитические дашборды**: графики, диаграммы, тренды на основе табличных данных
